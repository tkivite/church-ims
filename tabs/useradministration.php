        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="panel-heading panel-primary">
                    ...
                    <h2>User Administration  </h2><span> Helps you manage system users and roles </span>
                </div>
...
AND MENU_LEVEL = 1 AND IS_MENU = 1 AND MODULE = 'User Administration' ORDER BY MENU_POS ASC";   
