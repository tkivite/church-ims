...
$(document).on('click', '.gridResetPasswordButton', function () {
    ...
    if (resetItem) {
        ...
        $.ajax({
            type: 'post',
            url: '../../church-ims/Shared/php/process_form.php?f=' + formname + '&action=resetpassword',
...
$(document).on('click', '.gridDeleteButton', function () {
    ...
    if (deleteItem) {
        ...
        $.ajax({
            type: 'post',
            url: '../../church-ims/Shared/php/process_form.php?f=' + formname + '&action=delete',
            data: $("[name='" + formname + "']").serialize(),
            success: function (result) {
                // alert('done');
            },
...
$(document).on('click', '.gridCustomDelete', function () {
    ...
    console.log('../../church-ims/Shared/php/process_form.php?f=custom_delete&table_name=' + table_name + '&cell=' + cell_id + '&column=' + column);
    ...
    if (deleteItem) {
        ...
        $.ajax({
            type: 'post',
            url: '../../church-ims/Shared/php/process_form.php?f=custom_delete&table_name=' + table_name + '&cell=' + cell_id + '&column=' + column,
            // data: $("[name='" + formname + "']").serialize(),
            success: function (result) {
...
$(document).on('click', '.gridResendButton', function () {
    ...
    if (deleteItem) {
        ...
        $.ajax({
            type: 'post',
            url: '../../church-ims/Shared/php/process_form.php?f=' + formname + '&action=resend',
            data: $("[name='" + formname + "']").serialize(),
            success: function (result) {
                // alert('done');
            },
...
$(document).on('click', ".gridPinResetButton", function () {
    ...
    if (resetItem) {
        ...
        $.ajax({
            type: 'post',
            url: '../../church-ims/Shared/php/process_form.php?f=' + formname + '&action=resetpin&cell_id=' + cell_id,
            data: $("[name='" + formname + "']").serialize(),
            success: function (result) {
                //alert(result);
            },
...
$(document).on('click', ".gridChangePasswordButton", function () {
    ...
    if (deleteItem) {
        ...
        $.ajax({
            type: 'post',
            url: '../../church-ims/Shared/php/process_form.php?f=' + formname + '&action=resetpassword&cell_id=' + cell_id,
            data: $("[name='" + formname + "']").serialize(),
            success: function (result) {
        ...
        $.ajax({
            ...
            complete: function () {
                ...
                if (formName != 'product')
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/church-ims/onboarding/form/productTabs/reviewProductConfig.php',
