...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form method="POST" id="a" action="" class="newEntry panel-title">
            ...
            <div class="col-sm-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="numrows" id="numrows" value="" class=" form-control required"
                               placeholder="Enter number of records to be added">
                    </div>
                    <div class="col-sm-4">
        ...
        <form name="BULK_EXPENSE" method="POST" title="" class="HOUPTATEEXCEL" style="display: block;">
