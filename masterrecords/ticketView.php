...
$sql = "SELECT ID,Name,Email,Phone,Company,Department,Message,TimeCreated,Urgency FROM tickets WHERE ID = '" . $_GET[key] . "'";
GLOBAL $dblink;
...
?></dd>    </dl> 
     ...
     <dl class="dl-horizontal">
        <dt>Message: </dt>
        <dd><textarea id='message' class='form-control'rows="4" cols="70" readonly > <?php
echo $row[6];
?>  </textarea></dd>
    </dl> 
